import sixfab.gprsiotshield as sixfab
import time
from threading import Timer
import urllib2
import datetime

myAPI = "Y1CNTJC6Y9CYOWPW"
...
while 1:
	...
	for x in range(0, 3):
		try:
			...
			f = urllib2.urlopen(baseURL + "&field1=%d&field2=%d&field3=%d&field4=%d&field5=%d&field6=%d&field7=%d&field8=%d" % (s_hdctemp, s_humidity, s_lux, s_ds18b20temp, s_acc["x"], s_acc["y"], s_adc1, s_opto1))
			print f.read()
			f.close()
			print "send ok"
			break
